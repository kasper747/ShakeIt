<template>
    ...
    <v-card class="mb-5">
        <v-card-title>Jobs overview</v-card-title>
        ...
        <v-card class=" grey lighten-4 " v-for="(job, index) in positions.zeiss.open_positions">
            ...
            <v-layout row wrap>
                <v-flex xs12>
                    ...
                    <v-list-tile>
                        ...
                        <v-chip color="primary" text-color="white" label small
                                v-for="word in matching_words[index]">
                            {{ word }}
                        </v-chip>
                ...
                <v-flex xs12>
                    <v-list-tile>
                        ...
                        <v-chip label small v-for="location in job.location">
                            {{ location }}
                        </v-chip>
                    </v-list-tile>
                </v-flex>
            </v-layout>
            <v-layout class="dark purple  darken-2">
                <v-expansion-panel class="dark purple  darken-2">
                    <v-expansion-panel-content>
                        <template class="purple  darken-2" v-slot:header>
                            <div class=" text-xs-center" style="font-size: 12px"> Show job details
                            </div>
                        </template>
  ...
  export default {
    ...
    methods: {
      check_fit: function () {
        this.matching_words = [];
        this.testing = [];
        this.selected_skills = this.skills.designer.sel.concat(
            this.skills.back_dev.sel.concat(
                this.skills.front_dev.sel.concat(
                )));
